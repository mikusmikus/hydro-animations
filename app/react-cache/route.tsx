...
// React cache version
const getReactCachedRandomNumber = cache(async (): Promise<number> => {
...
export const generateMetadata = async () => {
  ...
  return {
    title: `Test React Cache ${randomNumber}`,
  }
}
...
export default async function TestReactCache() {
  ...
  return (
    <div className="p-8">
      <h1 className="text-2xl font-bold mb-4">Test WITH React Cache</h1>
